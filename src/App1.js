...
function App() {
  ...
  return (
    <ArtsContext.Provider value={[arts, setArts]}>
      ...
      <h1>Drawing App </h1>
      <div id="overlay">
      <h2 className="hide">This is a drawing app that allows you to draw and add your art to the online gallery. The gallery will display drawings added in the last 7 days! </h2>
      </div>
      <div className="paint">
        <Canvas
